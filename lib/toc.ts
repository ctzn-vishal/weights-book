  ...
  parts: [
      ...
      entries: [
        {
          ...
          credential: 'ATUS · synthetic population · interactive',
          status: 'draft',
        },
      ],
    },
      ...
      entries: [
        {
          ...
          dek: 'Turnout, work time, food insecurity, and poverty: telling a changed target from a changed estimator or an assumption about who did not answer.',
        ...
        },
        {
          ...
          key: 'ch3lab',
          number: 'Lab 3',
          title: 'Lab: How Much of a State Ranking Is Supported?',
    ...
    },
    {
      ...
      entries: [
        ...
        {
          slug: 'ch07-cluster-choice',
          key: 'ch7',
          number: '7',
          title: 'Whose Decision Was It? Clustering by the Source of Variation',
          dek: 'A state law, a classroom lottery, a rainfall shock, a trade exposure: in each study the standard error has to follow whoever, or whatever, made the variation.',
          credential: 'Six canonical designs · simulation with a known truth · fixest and pyfixest',
          status: 'draft',
        },
      ],
    },
