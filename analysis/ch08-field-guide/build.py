...
write_json(FIG / "surveys_at_a_glance.json", {
    ...
    "source": "Design manifests (design.json) and counts computed by ch08-field-guide/build.py; ATUS replicates per "
...
ledger = {"nhis_smoking": {
    ...
    "facts": ["ch8.nhis_smoking", "ch8.nhis_df", "ch8.nhis_strata", "ch8.nhis_psus", "ch8.nhis_crv1_ratio"],
}}
...
print(f"ch8: {len(F)} facts, {len(list(FIG.glob('*.json')))} figures; validation "
